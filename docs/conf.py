...
htmlhelp_basename = 'friendlypinsdoc'
...
latex_documents = [
    (master_doc, 'friendlypins.tex', 'friendlypins Documentation',
...
man_pages = [
    (master_doc, 'friendlypins', 'friendlypins Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'friendlypins', 'friendlypins Documentation',
     author, 'friendlypins', 'One line description of project.',
     'Miscellaneous'),
]
